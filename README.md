...
- **Tables — remaining bits**: cell span (`2+|`, `.3+|`, `2.3+|`), CSV/DSV separators, `a|` AsciiDoc cells (which require recursive block parsing of cell content).
